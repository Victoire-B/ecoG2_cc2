...
```{r}
qplot(sample_data(ps)$profondeur, geom = "histogram",binwidth=10) + xlab("profondeur")
```

```{r}
sample_data(ps)$age_binned <- cut(sample_data(ps)$age,
                          breaks = c("Fond","Median","Surface"))
levels(sample_data(ps)$age_binned) <- list(Young100="("_Fond"]", Mid100to200="("_Median"]", Old200="("_Surface"]")
